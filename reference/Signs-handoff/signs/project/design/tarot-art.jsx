// Tarot card art: woodcut-feel SVG sigils for each Major Arcana
// Each takes a "style" prop: woodcut | minimal | glyph
window.TarotArt = function({ card, style = "woodcut" }) {
  const stroke = style === "glyph" ? "var(--bone)" : "var(--ink)";
  const fill = style === "glyph" ? "var(--bone)" : "var(--ink)";
  ...
  const fallback = (
    <g {...common}>
      ...
      <text x="50" y="58" textAnchor="middle" fontFamily="Roboto Slab" fontSize="22" fontWeight="900" fill={fill} stroke="none">{card.num}</text>
